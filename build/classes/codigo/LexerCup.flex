...
/* Palabra reservada sumar */
( sumar ) {return new Symbol(sym.Op_Sumar, yychar, yyline, yytext());}

/* Palabra reservada restar */
( restar ) {return new Symbol(sym.Op_Restar, yychar, yyline, yytext());}

/* Palabra reservada multiplicar */
( multiplicar ) {return new Symbol(sym.Op_Multiplicar, yychar, yyline, yytext());}

/* Palabra reservada dividir */
( dividir ) {return new Symbol(sym.Op_Dividir, yychar, yyline, yytext());}

/* Palabra reservada potencia */
( potencia ) {return new Symbol(sym.Op_Potencia, yychar, yyline, yytext());}

/* Palabra reservada Memb_Access */
"->" {return new Symbol(sym.Memb_Access, yychar, yyline, yytext());}

/* Palabra reservada Power */
...
/* Identificador */
{L}({L}|{D})* {return new Symbol(sym.Identificador_Var, yychar, yyline, yytext());}
