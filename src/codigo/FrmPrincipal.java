...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Print:
                    ...
                    break;
                case Op_Sumar:
                    resultado += "  <Sumar>\t\t" + lexer.lexeme + "\n";
                    break;
                case Op_Restar:
                    resultado += "  <Restar>\t" + lexer.lexeme + "\n";
                    break;
                case Op_Multiplicar:
                    resultado += "  <Multiplicar>\t" + lexer.lexeme + "\n";
                    break;
                case Op_Dividir:
                    resultado += "  <Dividir>\t\t" + lexer.lexeme + "\n";
                    break;
                case Power:
                ...
                case Op_Potencia:
                    ...
                    break;
                case Identificador_Var:
                    resultado += "  <Identificador_Var>\t" + lexer.lexeme + "\n";
                    break;
                case Memb_Access:
                    resultado += "  <Memb_Access>\t" + lexer.lexeme + "\n";
                    break;
                case Numero:
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Analizador Sintactico", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Analizador Lexico", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
